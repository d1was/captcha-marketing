...
class Menu extends Model
{
	...
	public function getDefaultSettings()
	{
		return [
			...
			'has_children_class' => 'menu-item-has-children dropdown',
			...
			'before_url_item_label' => '<a href="%1$s" title="%6$s" class="menu-title" id="navbarLink" target="%7$s">', //array($url, $id, $id_attrib, $class_attrib, $depth, $title, $target)
			...
			'before_children' => '<ul class="dropdown-menu" aria-labelledby="navBarLink">',
			'after_children' => '</ul>',
		];
	}
